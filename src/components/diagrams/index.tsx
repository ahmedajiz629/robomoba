...
export function ArenaMapDiagram() {
  const lane = {
    fill: "none",
    stroke: "rgba(62, 207, 255, 0.28)",
    strokeWidth: 26,
    strokeLinecap: "round" as const,
    strokeLinejoin: "round" as const,
  };
  return (
    <Svg viewBox="0 0 680 520" role="img" aria-label="Two bases in opposite corners, three lanes connecting them, jungle between the lanes">
      <rect x="16" y="16" width="648" height="488" rx="14" fill="#12161c" stroke="rgba(255,255,255,0.12)" strokeWidth="1.5" />
      <rect x="28" y="28" width="624" height="464" rx="10" fill="rgba(255,180,90,0.045)" />

      <path d="M 64 96 L 616 392" stroke="rgba(62,207,255,0.14)" strokeWidth="40" fill="none" strokeLinecap="round" />

      <path d="M 128 392 L 128 76 L 500 76" {...lane} />
      <path d="M 168 404 L 512 132" {...lane} />
      <path d="M 168 448 L 560 448 L 560 148" {...lane} />

      <text x="86" y="230" fill="#3ecfff" fontSize="12" fontFamily={fontTitle} fontWeight="600">TOP</text>
      <text x="318" y="268" fill="#3ecfff" fontSize="12" fontFamily={fontTitle} fontWeight="600">MID</text>
      <text x="430" y="478" fill="#3ecfff" fontSize="12" fontFamily={fontTitle} fontWeight="600">BOT</text>

      <text x="250" y="150" fill="#ffb45a" fontSize="12" fontFamily={fontTitle} fontWeight="600">JUNGLE</text>
      <text x="430" y="330" fill="#ffb45a" fontSize="12" fontFamily={fontTitle} fontWeight="600">JUNGLE</text>

      <circle cx="168" cy="168" r="16" fill="rgba(255,180,90,0.16)" stroke="#ffb45a" />
      <circle cx="250" cy="210" r="12" fill="rgba(255,180,90,0.12)" stroke="#ffb45a" />
      <circle cx="470" cy="300" r="16" fill="rgba(255,180,90,0.16)" stroke="#ffb45a" />
      <circle cx="520" cy="250" r="12" fill="rgba(255,180,90,0.12)" stroke="#ffb45a" />
      <text x="168" y="198" textAnchor="middle" fill="#ffb45a" fontSize="9" fontFamily={fontBody}>Mana</text>
      <text x="470" y="330" textAnchor="middle" fill="#ffb45a" fontSize="9" fontFamily={fontBody}>Dragon</text>

      <circle cx="210" cy="118" r="7" fill="#3ecfff" opacity="0.7" />
      <circle cx="390" cy="118" r="7" fill="#3ecfff" opacity="0.7" />
      <circle cx="210" cy="430" r="7" fill="#3ecfff" opacity="0.7" />
      <circle cx="400" cy="430" r="7" fill="#3ecfff" opacity="0.7" />
      <circle cx="300" cy="268" r="7" fill="#3ecfff" opacity="0.7" />
      <text x="300" y="294" textAnchor="middle" fill="#6b7785" fontSize="9" fontFamily={fontBody}>Charge</text>

      <rect x="198" y="248" width="18" height="6" rx="1" fill="#eef2f6" transform="rotate(-38 207 251)" />
      <rect x="448" y="188" width="18" height="6" rx="1" fill="#eef2f6" transform="rotate(-38 457 191)" />
      <text x="188" y="276" fill="#9aa6b2" fontSize="9" fontFamily={fontBody}>Gate</text>

      <circle cx="128" cy="300" r="8" fill="#181e26" stroke="#3ecfff" />
      <circle cx="128" cy="180" r="8" fill="#181e26" stroke="#3ecfff" />
      <circle cx="300" cy="76" r="8" fill="#181e26" stroke="#3ecfff" />
      <circle cx="560" cy="300" r="8" fill="#181e26" stroke="#ffb45a" />
      <circle cx="560" cy="200" r="8" fill="#181e26" stroke="#ffb45a" />
      <circle cx="380" cy="448" r="8" fill="#181e26" stroke="#ffb45a" />
      <circle cx="280" cy="320" r="8" fill="#181e26" stroke="#3ecfff" />
      <circle cx="400" cy="220" r="8" fill="#181e26" stroke="#ffb45a" />

      <rect x="40" y="368" width="118" height="112" rx="10" fill="#181e26" stroke="#3ecfff" strokeWidth="1.6" />
      <circle cx="99" cy="424" r="16" fill="rgba(62,207,255,0.2)" stroke="#3ecfff" strokeWidth="1.5" />
      <text x="99" y="410" textAnchor="middle" fill="#3ecfff" fontSize="11" fontFamily={fontTitle} fontWeight="600">BASE</text>
      <text x="99" y="456" textAnchor="middle" fill="#eef2f6" fontSize="10" fontFamily={fontBody}>Nexus</text>

      <rect x="522" y="40" width="118" height="112" rx="10" fill="#181e26" stroke="#ffb45a" strokeWidth="1.6" />
      <circle cx="581" cy="96" r="16" fill="rgba(255,180,90,0.2)" stroke="#ffb45a" strokeWidth="1.5" />
      <text x="581" y="82" textAnchor="middle" fill="#ffb45a" fontSize="11" fontFamily={fontTitle} fontWeight="600">BASE</text>
      <text x="581" y="128" textAnchor="middle" fill="#eef2f6" fontSize="10" fontFamily={fontBody}>Nexus</text>
    </Svg>
  );
}

export function ArenaObjectsDiagram() {
  return (
    <Svg viewBox="0 0 720 168" role="img" aria-label="Physical arena objects with their own lighting">
      <g>
        <rect x="12" y="16" width="132" height="136" rx="10" fill="#181e26" stroke="#3ecfff" strokeWidth="1.4" />
        <circle cx="78" cy="52" r="16" fill="rgba(62,207,255,0.2)" stroke="#3ecfff" strokeWidth="1.6" />
        <circle cx="78" cy="52" r="5" fill="#3ecfff" />
        <text x="78" y="88" textAnchor="middle" fill="#eef2f6" fontSize="11" fontFamily={fontTitle} fontWeight="600">Nexus / turret</text>
        <text x="78" y="108" textAnchor="middle" fill="#9aa6b2" fontSize="10" fontFamily={fontBody}>Physical + own light</text>
        <text x="78" y="126" textAnchor="middle" fill="#6b7785" fontSize="10" fontFamily={fontBody}>Mine too</text>
      </g>
      <g>
        <rect x="156" y="16" width="132" height="136" rx="10" fill="#181e26" stroke="#ffb45a" strokeWidth="1.4" />
        <ellipse cx="222" cy="52" rx="22" ry="14" fill="rgba(255,180,90,0.2)" stroke="#ffb45a" />
        <circle cx="214" cy="48" r="4" fill="#ffb45a" />
        <text x="222" y="88" textAnchor="middle" fill="#eef2f6" fontSize="11" fontFamily={fontTitle} fontWeight="600">Mana / Dragon</text>
        <text x="222" y="108" textAnchor="middle" fill="#9aa6b2" fontSize="10" fontFamily={fontBody}>Physical camp</text>
        <text x="222" y="126" textAnchor="middle" fill="#6b7785" fontSize="10" fontFamily={fontBody}>Moves in place</text>
      </g>
      <g>
        <rect x="300" y="16" width="132" height="136" rx="10" fill="#181e26" stroke="#3ecfff" strokeWidth="1.4" />
        <rect x="342" y="40" width="48" height="24" rx="4" fill="rgba(62,207,255,0.12)" stroke="#3ecfff" />
        <text x="366" y="88" textAnchor="middle" fill="#eef2f6" fontSize="11" fontFamily={fontTitle} fontWeight="600">Charge station</text>
        <text x="366" y="108" textAnchor="middle" fill="#9aa6b2" fontSize="10" fontFamily={fontBody}>Consumable</text>
        <text x="366" y="126" textAnchor="middle" fill="#6b7785" fontSize="10" fontFamily={fontBody}>Then cooldown</text>
      </g>
      <g>
        <rect x="444" y="16" width="132" height="136" rx="10" fill="#181e26" stroke="#3ecfff" strokeWidth="1.4" />
        <rect x="478" y="44" width="64" height="10" rx="2" fill="#eef2f6" />
        <text x="510" y="88" textAnchor="middle" fill="#eef2f6" fontSize="11" fontFamily={fontTitle} fontWeight="600">Gate</text>
        <text x="510" y="108" textAnchor="middle" fill="#9aa6b2" fontSize="10" fontFamily={fontBody}>Activated</text>
        <text x="510" y="126" textAnchor="middle" fill="#6b7785" fontSize="10" fontFamily={fontBody}>Opens / closes</text>
      </g>
      <g>
        <rect x="588" y="16" width="120" height="136" rx="10" fill="#181e26" stroke="#ffb45a" strokeWidth="1.4" />
        <rect x="622" y="38" width="52" height="28" rx="3" fill="rgba(255,180,90,0.16)" stroke="#ffb45a" />
        <text x="648" y="88" textAnchor="middle" fill="#eef2f6" fontSize="11" fontFamily={fontTitle} fontWeight="600">Movable</text>
        <text x="648" y="108" textAnchor="middle" fill="#9aa6b2" fontSize="10" fontFamily={fontBody}>Robots shift it</text>
        <text x="648" y="126" textAnchor="middle" fill="#6b7785" fontSize="10" fontFamily={fontBody}>Changes a path</text>
      </g>
    </Svg>
  );
}
